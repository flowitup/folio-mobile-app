...
export interface paths {
  ...
  "/api/v1/companies": {
    ...
    put?: never;
    /** Create a new company (self-service — any authenticated user) */
    post: {
      parameters: {
        query?: never;
        header?: never;
  ...
  "/api/v1/companies/{company_id}/attached-users": {
    ...
    /** List users attached to a company (company admin) */
    get: {
      parameters: {
        query?: never;
        header?: never;
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json": components["schemas"]["AttachedUsersListResponse"];
          };
        };
      };
    };
  ...
  "/api/v1/companies/{company_id}/members": {
    ...
    get?: never;
    put?: never;
    /** Add a company member by phone number (admin only) */
    post: {
      parameters: {
        query?: never;
        header?: never;
      ...
      requestBody: {
        content: {
          "application/json": components["schemas"]["AddMemberByPhoneRequest"];
        };
      };
      responses: {
        /** @description Success */
  ...
  "/api/v1/companies/{company_id}/members/import": {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    get?: never;
    put?: never;
    /** Import member profiles from another company the caller also admins */
    post: {
      parameters: {
        query?: never;
        header?: never;
      ...
      requestBody: {
        content: {
          "application/json": components["schemas"]["ImportMembersRequest"];
        };
      };
      responses: {
        /** @description Success */
  ...
  "/api/v1/companies/{company_id}/members/{user_id}/grants": {
    ...
    /** List a company member's D8 grant/deny rows */
    get: {
      parameters: {
        query?: never;
        header?: never;
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json": components["schemas"]["MemberGrantsListResponse"];
          };
        };
      };
    };
    /** Grant or deny one permission to a company member (D8) */
    put: {
      parameters: {
        query?: never;
        header?: never;
      ...
      requestBody: {
        content: {
          "application/json": components["schemas"]["SetMemberGrantRequest"];
        };
      };
      responses: {
        /** @description OK */
        200: {
          ...
          content: {
            "application/json": components["schemas"]["MemberGrantRow"];
          };
        };
      };
    };
    post?: never;
    /** Remove a grant/deny row from a company member (D8) */
    delete: {
      parameters: {
        query?: never;
        header?: never;
      ...
      requestBody: {
        content: {
          "application/json": components["schemas"]["RemoveMemberGrantRequest"];
        };
      };
      responses: {
        /** @description Success */
  ...
  "/api/v1/companies/{company_id}/persons": {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    /** List a company's member directory (admin or manager) */
    get: {
      parameters: {
        query?: never;
        header?: never;
  ...
  "/api/v1/projects/{project_id}/labor/roster": {
    ...
    /** Day roster for a project: name, presence, hours, day type (never pay) */
    get: {
      parameters: {
        query: {
          date: string;
...
export interface components {
  schemas: {
    ...
    AttachedUsersListResponse: {
      /** Items */
      items: components["schemas"]["AttachedUserRow"][];
      /** Total */
      total: number;
    };
    /** AttachmentResponse */
     ...
     * @description Request body for POST /companies/<id>/members/import.
     */
    ImportMembersRequest: {
      /**
       * From Company Id
    ...
    /**
     * MemberGrantRow
     * @description One grant/deny row in the member-grants API responses.
     */
    MemberGrantRow: {
      /**
       * Effect
    ...
    MemberGrantsListResponse: {
      ...
      customisable: string[];
      /** Grants */
      grants: components["schemas"]["MemberGrantRow"][];
    };
    /** MemberResponse */
    MemberResponse: {
      /** Id */
     ...
     * @description Request body for DELETE /companies/<company_id>/members/<user_id>/grants.
     */
    RemoveMemberGrantRequest: {
      /** Permission */
      permission: string;
    ...
    /**
     * RosterResponse
     * @description Response body for GET /projects/<id>/labor/roster.
     */
    RosterResponse: {
      /** Rows */
    ...
    /**
     * RosterRowResponse
     * @description One worker's day — the D3 whitelist. Never rate/cost/amount/total.
     */
    RosterRowResponse: {
      /**
       * Day Type
     ...
     * @description Request body for PUT /companies/<company_id>/members/<user_id>/grants.
     */
    SetMemberGrantRequest: {
      /**
       * Effect
    ...
    /**
     * UserCompanySummary
     * @description One company the user is attached to — company role, not global RBAC.
     */
    UserCompanySummary: {
      /**
       * Id
