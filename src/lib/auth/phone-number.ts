 ...
 * user types ("06 12 34 56 78", "6 12 34 56 78", "+33 6 12 34 56 78", "0033…") and turns it into E.164 so it can be
...
/** A French number written without its trunk 0, as the field's own `FR +33` chip invites. */
